...
// Drives the interactive star pickers on the car rating form and submits the form
// over Turbo Streams. Mirrors app/javascript/controllers/track_rating_controller.js.
export default class extends Controller {
    ...
    inputFor(field) {
        return field.querySelector('[data-car-rating-target="input"]')
    }

    paint(field, value) {
        field.querySelectorAll('[data-car-rating-target="star"]').forEach((star) => {
